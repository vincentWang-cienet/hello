...
import com.tsu.config.MyApplication;

/**
 * 创建悬浮窗口：目前是悬浮的ImageView，可根据需求自己修改
 * @author dds
 *
 */
...
public class WindowUI {
	 ...
	 * @param l 单击事件
	 */
	public static void  createFloatWindow(Context context,int id,OnClickListener l){
		removeFloatWindow();
		wm =(WindowManager) context.getApplicationContext().getSystemService(
				Context.WINDOW_SERVICE);;
		WindowManager.LayoutParams wmlp = ((MyApplication) (context.getApplicationContext())).getLayoutParams();
